              ...
              <div class="nk-block-head nk-block-head-sm">
                  <div class="nk-block-between">
                      <div class="nk-block-head-content">
                          <h4 class="nk-block-title ">Upload Processed Files</h4>
                              ...
                              <div class="card-inner">
                                  <div class="card-title-group align-start pb-3 g-2">
                                      <div class="card-title">
                                          <h6 class="title">Processed Files Upload</h6>
                                      </div>
                                  ...
                                  <div class="card">
                                    <form action="#"  id="processedFilesForm" enctype="multipart/form-data">
                                        ...
                                        <div class="row g-gs">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <button type="submit" class="btn btn-md btn-primary"><i class="fa fa-plus-circle"></i> <i id="loader" class="fa fa-spinner fa-spin"></i> Upload Processed Files</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
...
<script>
  $(document).ready(function(){
     ...
     $('#processedFilesForm').submit(function(event) {
      ...
      Swal.fire({
        title: 'File Upload',
        text: "You are about to upload processed files for a claim",
        icon: 'warning',
