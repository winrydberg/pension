              ...
              <div class="nk-block-head nk-block-head-sm">
                  <div class="nk-block-between">
                      <div class="nk-block-head-content">
                          <h4 class="nk-block-title">Claims With Issue</h4>
                          <div class="nk-block-des text-soft">
                              <p>On this page, you will find all claims with issue pending resolution. You can use the search to filter by description, claim id etc.</p>
                          </div>
                                ...
                                @foreach($claims as $claim)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url('/issue-review?ticket='.$claim->issues[0]?->issue_ticket)}}" class="btn btn-sm btn-round btn-warning"><em class="icon ni ni-info"></em> <span>Resolve Issue</span></a>
