              ...
              <div class="nk-block-head nk-block-head-sm">
                  <div class="nk-block-between">
                      <div class="nk-block-head-content">
                          <h4 class="nk-block-title ">Upload Audited Files</h4>
                          <div class="nk-block-des text-soft">
                              <p>Upload audited files. This action will update claim state to audited.</p>
                          </div>
                              ...
                              <div class="card-inner">
                                  <div class="card-title-group align-start pb-3 g-2">
                                      <div class="card-title">
                                          <h6 class="title">Audited Files Upload</h6>
                                      </div>
                                        ...
                                        <div class="row g-gs">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" readonly value="{{$claim->claimid}}" readonly class="form-control" id="claimid" name="claimid">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <button type="submit" class="btn btn-md btn-primary"><i class="fa fa-plus-circle"></i> <i id="loader" class="fa fa-spinner fa-spin"></i> Upload Audited Files</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
...
<script>
  $(document).ready(function(){
     ...
     $('#processedFilesForm').submit(function(event) {
      ...
      Swal.fire({
        title: 'File Upload',
        text: "You are about to upload audited files files for a claim. This will update claim state to audited. Are you sure?",
        icon: 'warning',
