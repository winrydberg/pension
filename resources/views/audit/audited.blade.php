              ...
              <div class="nk-block-head nk-block-head-sm">
                  <div class="nk-block-between">
                      <div class="nk-block-head-content">
                          <h4 class="nk-block-title">Audited Claims</h4>
                          <div class="nk-block-des text-soft">
                              <p>On this page, you will find claims audited but not received by scheme administators </p>
                          </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('claim-details?claimid='.$claim->claimid)}}" class="btn btn-round btn-sm btn-info"> <em class="icon ni ni-eye"></em> <span>Claims Details</span></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
