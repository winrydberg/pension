                  ...
                  <div class="nk-block-between">
                      <div class="nk-block-head-content">
                          ...
                          <div class="nk-block-des text-soft">
                              <p>Generate reports by company</p>
                          </div>
                              ...
                              <div class="card-inner">
                                  <div class="card-title-group align-start pb-3 g-2">
                                      <div class="card-title">
                                          <h6 class="title">Generate Company Reports</h6>
                                      </div>
                                    ...
                                    <form action="#"  id="searchClaim" method="GET">
                                        ...
                                        <div class="row g-gs">
                                            <div class="row" style="margin-top: 30px;">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="form-label" for="fva-message">Company</label>
                                                        <div class="form-control-wrap">
                                                            <select class="form-control select2" name="company" required>
                                                                <option value="">Select an option</option>
                                                                @foreach($companies as $company)
                                                                     <option value="{{$company->id}}" {{request()->get('company') ==  $company->id? 'selected="selected"' : ''}}>{{$company->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card card-bordered card-preview">
                            <div class="card-inner">
                                ...
                                <a href="{{url('/excel-reports?company='.request()->query('company').'&startdate='.request()->query('startdate').'&enddate='.request()->query('enddate'))}}" class="btn btn-success btn-md btn-round"><em class="icon ni ni-download"></em> <span>Export To Excel</span></a>
                                    ...
                                    <tbody>
                                        @foreach($claims as $claim)
                                            <tr>
                                                ...
                                                <td>{{$claim->sums}}</td>
                                                <td>
                                                    <a href="{{url('/reports-breakdown?month='.$claim->months.'&company='.$selcompany->id)}}" class="btn btn-primary btn-round btn-sm"><em class="icon ni ni-info"></em> <span>Breakdown</span></a>
                                ...
                                @else
                                 <p class="alert alert-danger">No claims found for selected dates and company</p>
                                @endif
                            </div>
                        </div><!-- .card-preview -->
                    </div>
